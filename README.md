...
<body>
  <div class="container">
    ...
    <div class="illustration">
      <!-- Ilustração simplificada com SVG -->
      <svg viewBox="0 0 600 400">
        <circle cx="300" cy="200" r="80" fill="#4db8a9" />
        <rect x="90" y="250" width="100" height="100" fill="#2e7d32" rx="10"/>
        <rect x="410" y="250" width="100" height="100" fill="#2e7d32" rx="10"/>
        <polygon points="250,250 350,250 300,180" fill="#81c784"/>
        <rect x="280" y="230" width="40" height="100" fill="#a1887f" rx="10"/>
        <circle cx="480" cy="180" r="20" fill="#66bb6a"/>
        <circle cx="120" cy="180" r="20" fill="#66bb6a"/>
        <!-- símbolo de reciclagem -->
        <path d="M310,120 L330,150 L310,150 M330,150 L350,120" stroke="#2e7d32" stroke-width="6" fill="none"/>
        <path d="M290,150 L270,180 L290,180 M270,180 L250,150" stroke="#2e7d32" stroke-width="6" fill="none"/>
        <path d="M300,200 L320,230 L300,230 M320,230 L340,200" stroke="#2e7d32" stroke-width="6" fill="none"/>
      </svg>
    </div>
  </div>
</body>
